...
| 템플릿 | 출처 |
|---|---|
| `function/templates/이력서_표준서식.docx` | 2026-07-13 LG U+ 지원본 (워드에서 직접 다듬은 판) |
| `function/templates/자기소개서_표준서식.docx` | 2026-07-13 Upstage 218421 제출본 |
...
템플릿을 갈아도 코드는 그대로다. 새 표준 서식이 생기면 `function/templates/` 의 docx 를 교체하면 끝.
